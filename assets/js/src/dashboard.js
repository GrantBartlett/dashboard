...
$(function () {
    ...
    $.getScript("/assets/js/src/get_members.js", function (data, textStatus, jqxhr) {
        //getMembers.getMemberData();
        console.log(getMembers.getMemberData());
    });
...
//
//        /**
//         * GETS MEMBERS BY WEEK (ITERATIVE)
//         */
//
